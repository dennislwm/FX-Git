...
void init() {
   ...
   if (gi_904 == 9999) {
      ...
      for (int pos_96 = 0; pos_96 < OrdersTotal(); pos_96++) {
         ...
         if (OrderMagicNumber() != gi_1232 || OrderSymbol() != Symbol()) continue;
         ld_88 += OrderProfit();
      }
            ...
            if (gi_1232 == OrderMagicNumber()) {
               ...
               if (a_symbol_0 == OrderSymbol()) {
                  ...
                  while (!li_56) {
                     ...
                     g_order_profit_520 = OrderProfit();
                     if (cmd_48 == OP_BUY) OrderClose(OrderTicket(), OrderLots(), price_72, ai_20 * g_point_2872, CLR_NONE);
                     else
                        if (cmd_48 == OP_SELL) OrderClose(OrderTicket(), OrderLots(), price_64, ai_20 * g_point_2872, CLR_NONE);
...
int f0_12(string a_symbol_0, double ad_8, string a_comment_16, int ai_24, int ai_28, int a_magic_32, int ai_36, int ai_40) {
   ...
   for (int count_64 = 0; count_64 < li_60; count_64++) {
      ...
      while (!li_76) {
         ...
         ticket_68 = OrderSend(a_symbol_0, OP_BUY, lots_84, price_92, 0, 0.0, 0.0, a_comment_16, a_magic_32, ai_40 * g_point_2872, CLR_NONE);
         price_108 = f0_9(price_92, ai_24, g_point_2872, g_digits_2868);
         error_116 = GetLastError();
         if (error_116 == 0/* NO_ERROR */) {
            gs_3240 = "BUYTRADE";
            if (OrderMagicNumber() == a_magic_32) gs_unused_3224 = "BUY";
            if (OrderMagicNumber() == gi_1232) gs_unused_3224 = "BUY";
            gs_true_3472 = "False";
         }
         switch (error_116) {
         case 135/* PRICE_CHANGED */: continue;
         ...
         case 0/* NO_ERROR */:
            li_76 = TRUE;
            if (OrderSelect(ticket_68, SELECT_BY_TICKET)) OrderModify(ticket_68, OrderOpenPrice(), price_108, f0_13(price_92, ai_28, g_point_2872, g_digits_2868), 0, CLR_NONE);
            if (gi_3156 == TRUE) {
               ...
               gi_100 = TRUE;
               g_order_open_price_580 = OrderOpenPrice();
               ...
               if (gd_3688 == 1.0) {
                  g_order_open_price_168 = OrderOpenPrice();
                  g_order_stoploss_132 = OrderStopLoss();
...
int f0_0(string a_symbol_0, double ad_8, string a_comment_16, int ai_24, int ai_28, int a_magic_32, int ai_36, int ai_40) {
   ...
   for (int count_64 = 0; count_64 < li_60; count_64++) {
      ...
      while (!li_76) {
         ...
         ticket_68 = OrderSend(a_symbol_0, OP_SELL, lots_84, price_100, 0, 0.0, 0.0, a_comment_16, a_magic_32, ai_40 * g_point_2872, CLR_NONE);
         error_116 = GetLastError();
         if (error_116 == 0/* NO_ERROR */) {
            gs_3240 = "SELLTRADE";
            if (OrderMagicNumber() == a_magic_32) gs_unused_3224 = "SELL";
            if (OrderMagicNumber() == gi_1232) gs_unused_3224 = "SELL";
            gs_true_3472 = "False";
         }
         switch (error_116) {
         case 135/* PRICE_CHANGED */: continue;
         ...
         case 0/* NO_ERROR */:
            li_76 = TRUE;
            if (OrderSelect(ticket_68, SELECT_BY_TICKET)) OrderModify(ticket_68, OrderOpenPrice(), price_108, f0_4(price_100, ai_28, g_point_2872, g_digits_2868), 0, CLR_NONE);
            if (gi_3156 == TRUE) {
...
void f0_7() {
   ...
   for (int pos_12 = OrdersTotal() - 1; pos_12 >= 0; pos_12--) {
      if (OrderSelect(pos_12, SELECT_BY_POS) && OrderMagicNumber() == gi_1232 && OrderSymbol() == Symbol() && OrderOpenTime() > datetime_4) {
         datetime_4 = OrderOpenTime();
         ticket_8 = OrderTicket();
      }
   }
   if (OrderSelect(ticket_8, SELECT_BY_TICKET) == TRUE) g_order_open_price_176 = OrderOpenPrice();
}
...
void f0_14() {
   ...
   if (Seconds() == 0 || gi_2628 == 0) {
      ...
      for (int pos_176 = 0; pos_176 < OrdersTotal(); pos_176++) {
         if (OrderSelect(pos_176, SELECT_BY_POS, MODE_TRADES) == FALSE) break;
         if (OrderMagicNumber() != gi_1232 || OrderSymbol() != Symbol()) continue;
         ld_168 += OrderProfit();
      }
      ObjectSetText("OpenTrade", "", 10, "Arial", White);
