...
extern double VolatilityFactor2 = 1.5;
extern int AtrPeriod = 19;
extern double AtrFactor = 0.0019;
extern double AtrFactor2 = 0.0020;
double gd_148 = 0.5;
double gd_156 = 0.2;
int gi_164 = 50;
...
int start() {
   ...
   double ld_80;
   int li_92;
   double VolRatio,VolRatio2,AtrRatio,AtrRatio2;
   double ld_104;
   double ld_112;
   double ld_120;
   double ld_128;
      ...
      for (ld_60 = gi_224; ld_60 <= gi_228; ld_60++) {
         ...
         for (pos_28 = 0; pos_28 < gi_232; pos_28++) {
            ...
            if (ArraySize(Close) > 101) {
               ...
               VolRatio2 = GetVolatilityRatio(PriceClose, PriceOpen, 3, 50, 100, AccountNo);
               AtrRatio = iATR(NULL,0,AtrPeriod,0);
               AtrRatio2 = iATR(NULL,0,14,0);
               if (UseFilter==true && MathAbs(VolRatio) >= VolatilityFactor && MathAbs(VolRatio2) >= VolatilityFactor2 && AtrRatio >= AtrFactor && AtrRatio2 >= AtrFactor2) {
               ...
               else if (UseFilter==false && MathAbs(VolRatio) >= VolatilityFactor) {
                  if (VolRatio > 0.0) li_92 = 1;
                  else li_92 = -1;
                  gi_356 += li_92;
                  if (MathAbs(gi_356) > gi_360) {
