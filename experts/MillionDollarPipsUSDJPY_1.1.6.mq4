...
*/
#property copyright "Copyright ï¿½ 2011"
         ...
         if (li_140 != -1) {
            ...
            if (Use_Stop_Orders) {
               if (Hard_Stop_Trailing) {
                  ...
                  if (!IsTesting()) {
                     gi_1744 = TRUE;
                     ticket_72 = OrderSend(Symbol(), cmd_76, a_lots_56, price_96, Slippage, price_104 - 80 * li_136 / 1000.0, price_112 + 80 * li_136 / 1000.0, OrderCmt, Magic, gi_1680,
                        color_80);
                  } else {
                     gi_1744 = TRUE;
