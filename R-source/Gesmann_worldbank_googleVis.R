#|------------------------------------------------------------------------------------------|
#|                                                            Gesmann_worldbank_googleVis.R |
#|                                                             Copyright © 2012, Dennis Lee |
#| Assert Background                                                                        |
#|    The original post came from a blog:                                                   |
#|  http://lamages.blogspot.co.uk/2011/09/accessing-and-plotting-world-bank-data.html       |
#|                                                                                          |
#|    This demo shows how country level data can be accessed from the World Bank via their  |
#|  API and displayed with a Motion Chart. Inspired by Google's Public Data Explorer, see   |
#|  http://www.google.com/publicdata/home                                                   |
#|                                                                                          |
#|    For the World Bank Data terms of use see:                                             |
#|  http://data.worldbank.org/summary-terms-of-use                                          |
#|                                                                                          |
#|    To run this demo an internet connection and Flash are required. This demo is part of  |
#|  the googleVis R package.                                                                |
#|                                                                                          |
#|    Markus Gesmann, 24 September 2011 Distributed under GPL 2 or later                    |
#|                                                                                          |
#| Assert History                                                                           |
#|  1.0.0   This script originated from a blog by author Markus Gesmann.                    |
#|------------------------------------------------------------------------------------------|
library('googleVis')
