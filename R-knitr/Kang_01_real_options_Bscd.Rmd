...
sigma       <- 0.2
top.month   <- 68
top.year    <- top.month/12
rf          <- 0.03
aqua.bscd   <- BscdCreateModel(rf, 0, top.month, top.year, sigma)
bench.bscd  <- BscdCreateModel(rf, 0.09, top.month, top.year, sigma)
...
plot(seq(1,4,by=1), obs.op, col=seq(1:4),
