...
exe.dir   <- paste0(RegProgramDir(), "mq4_converter/")
ea.dir    <- RegEaDir()
ea.dir
java.dir  <- RegJavaDir()
...
if( errNum != 0 ) errNum
if( !file.exists(paste0(java.dir, java.str)) )
  stop(paste0(java.str, ' is missing (OR NOT converted correctly)'))
mt.list <- lapply(readLines(paste0(java.dir, java.str)), function(x) scan(text=x, sep=" ", what=c("char"), strip.white=c(FALSE)))
```
