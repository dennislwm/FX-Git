...
int start() {
   ...
   if (ActiveStatus == 0 && AccountNo > 0) {
      ...
      if (GetLicenseState(AccountNo) != 0) {
         ...
         text_0 = "";
         if (ActiveStatus == 1) text_0 = "ForexGrowthBot" + gs_140 + "license status: ACTIVE" + VizComment();
   ...
   if (iTime(NULL, Period(), 0) - g_datetime_148 >= 5) {
      ...
      text_12 = "";
      if (active == 1) text_12 = "ForexGrowthBot" + gs_140 + "license status: ACTIVE" + VizComment();
